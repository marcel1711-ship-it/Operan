...
export default function OperanFinalCTA() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden py-32 lg:py-40">
      ...
      <div className="absolute left-1/2 top-1/2 h-[500px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#2563EB]/8 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <div className={`operan-reveal ${isVisible ? 'is-visible' : ''}`}>
          ...
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.03] px-3 py-1.5">
            ...
            <span className="text-xs font-medium text-[#94A3B8]">Request Early Access · Book a Demo</span>
          </div>

          {/* Headline */}
          <h2 className="text-balance text-5xl font-semibold leading-[1.05] tracking-tight text-white sm:text-6xl lg:text-7xl">
            Ready to run{' '}
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              href="/login"
              className="group relative inline-flex items-center justify-center gap-2 rounded-xl bg-[#2563EB] px-7 py-4 text-sm font-medium text-white transition-all hover:bg-[#1D4ED8] operan-glow-sm"
            >
