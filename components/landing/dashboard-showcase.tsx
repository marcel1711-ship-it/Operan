...
export default function OperanDashboardShowcase() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden py-24 lg:py-32">
      {/* Background glow */}
      <div className="absolute left-1/2 top-1/2 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#6377FF]/5 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          <div className="relative">
            {/* Outer glow */}
            <div className="absolute -inset-8 rounded-3xl bg-gradient-to-br from-[#6377FF]/10 via-transparent to-transparent blur-3xl" />
              ...
              <div className="flex min-h-[500px]">
                ...
                <div className="hidden w-48 shrink-0 border-r border-white/[0.06] p-4 lg:block">
                  <div className="mb-6 flex items-center gap-2">
                    <OperanLogoIcon size={24} />
                    <span className="text-xs font-bold text-white">OPERAN</span>
                  </div>
                    ...
                    {[
                      ...
                      <div
                        ...
                        className={`flex items-center gap-2 rounded-lg px-3 py-2 text-xs ${
                          item.active
                            ? 'bg-[#6377FF]/12 text-white'
                            : 'text-[#94A3B8]/60'
                        }`}
                      >
                        <div className={`h-1.5 w-1.5 rounded-full ${item.active ? 'bg-[#6377FF]' : 'bg-white/10'}`} />
                        {item.label}
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex-1 p-6">
                  ...
                  <div className="mb-6 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="rounded-lg bg-[#6377FF] px-3 py-1.5 text-xs font-medium text-white">
                        + New Booking
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
                    {[
                      { label: 'Today\'s Charters', value: '8', trend: '+2', color: '#6377FF' },
                      { label: 'Revenue (MTD)', value: '$84.2k', trend: '+24%', color: '#14B8A6' },
                      { label: 'Pending Waivers', value: '3', trend: '-5', color: '#F59E0B' },
                      { label: 'Occupancy', value: '92%', trend: '+7%', color: '#6377FF' },
                    ].map((kpi, i) => (
                      <div
                        key={kpi.label}
                    ...
                    <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 lg:col-span-2">
                      <div className="mb-4 flex items-center justify-between">
                        ...
                        <div className="flex gap-1.5">
                          ...
                          <div className="rounded-md bg-[#6377FF]/12 px-2 py-1 text-[9px] font-medium text-[#6377FF]">90D</div>
                        </div>
                      </div>
                      <div className="flex h-32 items-end gap-1">
                        {Array.from({ length: 30 }).map((_, i) => {
                          ...
                          return (
                            <div
                              key={i}
                              className="flex-1 rounded-t bg-gradient-to-t from-[#6377FF]/20 to-[#6377FF]/60"
                              style={{
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={trip.name} className="flex items-center gap-3">
                            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#6377FF]/10 text-[10px] font-medium text-[#6377FF]">
                              {trip.time.split(':')[0]}
                            </div>
