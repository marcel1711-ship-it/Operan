...
import {
  LayoutDashboard, Ship, CalendarDays, FileSignature, Anchor, Compass,
  Settings, LogOut, ChevronDown, ClipboardList, Users, GitBranch,
  Zap, Mail, BarChart3, Plug, CreditCard, MessageSquare, BarChart, Building2, UserCog, ShieldCheck, Palette, Bell, Receipt,
} from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside
        className="fixed left-0 top-0 z-50 hidden h-screen w-[280px] flex-col lg:flex"
        style={{
      ...
      >
        ...
        <div className="px-6 pt-10 pb-8">
          <div className="flex items-center gap-3.5">
            <div
              className="flex h-[52px] w-[52px] shrink-0 items-center justify-center rounded-[14px] border border-[var(--brand-primary)]/20 bg-[var(--brand-primary)]/[0.10]"
            >
        ...
        {/* Navigation */}
        <nav className="sidebar-scroll flex flex-1 flex-col overflow-y-auto px-4 pb-4">
          {navSections.map((section) => (
            <div key={section.label} className="flex flex-col" style={{ marginBottom: '28px' }}>
              <p
